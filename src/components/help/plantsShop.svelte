<script>
  ...
  export let callToAction = {
    ...
    description:
      "Curae quia enim aute, consequatur, eius quaerat excepteur fames pharetra.",
...
<div>
  ...
  <div
    class="flex flex-col lg:flex-row justify-around py-16 px-6 lg:px-10 items-center align-center"
  >
    {#each sections as section}
      <!-- Background Section -->
      <div
        class="relative bg-cover bg-center flex py-4 justify-center flex-col text-left h-80 w-full lg:w-1/2 flex-shrink-0 mb-6 lg:mb-0"
      ...
      >
        ...
        <div class="relative z-10 pl-6 lg:pl-16">
          <h1 class="font-bold text-xl lg:text-2xl py-2 text-white">
            {section.title}
          </h1>
          <p class="text-white pb-2">{section.description}</p>
          <Button
            class="mt-6 px-4 hover:text-black
          "
...
<div class="flex flex-col items-center py-16 text-center px-4 pb-10 lg:px-0">
  <h1 class="font-extrabold text-3xl lg:text-5xl py-6 lg:py-10">
    {callToAction.title}
  </h1>
  <p class="text-gray-500 text-base lg:text-lg pb-6 lg:pb-10">
    {callToAction.description}
  </p>
  <Button class="mt-6 hover:text-black bg-red-950 px-4" on:click={callToAction.onClick}
