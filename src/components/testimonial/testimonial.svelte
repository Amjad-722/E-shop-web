<script>
  ...
  <main class="h-dvh mt-16 relative">
    ...
    <div class="absolute inset-0 bg-cover bg-center opacity-50" style="background-image: url('https://png.pngtree.com/thumb_back/fh260/background/20230613/pngtree-some-green-plants-and-leaves-against-a-dark-background-image_2899643.jpg');"></div>
    ...
    <div class="relative grid grid-cols-1 md:grid-cols-2 gap-8 px-12 z-10 justify-items-center">
      {#each testimonials as testimonial}
        <div
          class="border-2 border-gray-300 hover:border-blue-500 transition duration-300 p-6 rounded-md shadow-md bg-white bg-opacity-80  w-full"
        >
